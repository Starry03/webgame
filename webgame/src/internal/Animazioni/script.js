...
window.addEventListener('keyup', (event) => {
    ...
    if (!keysPressed['ArrowRight'] && !keysPressed['ArrowLeft'] && !keysPressed['ArrowUp'] && !keysPressed['ArrowDown']) {
        direction = null; // Nessuna direzione
        if (!animationInProgress) { // Solo se non ci sono animazioni bloccanti
