...
sprite_sheet = Image.open('Run.png')

# Specifica le dimensioni di ogni frame e il numero di colonne/righe
sprite_width = 96  # Larghezza di ogni sprite
sprite_height = 96  # Altezza di ogni sprite
columns = 6  # Numero di colonne nello sprite sheet
